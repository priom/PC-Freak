<!-- menus.php -->
    <nav onmouseout="hide()">
      <ul class="Links">
        ...
        <li>
          <span onmouseover="show('m4')">Build Your PC</span>
          <div id="m4" onmouseover="show('m4')">
            <a href="pages/estimator.php">Get An Estimate</a>
            <a href="pages/resources.php">Tools+Resources</a>
        ...
        <li>
          ...
          <div id="m5" onmouseover="show('m5')">
            <a href="pages/about.php">About PC-Freak</a>
        ...
        <li><a href="pages/sitemap.php" onmouseover="show('m7')">SiteMap</a></li>
      </ul>
    </nav>
